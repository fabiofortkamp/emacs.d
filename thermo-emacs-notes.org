...
Regularly, I have to clean a note I call "Master Projec List", which contains an overview of my week. There is a snippet for markdown-mode called "master-project-list", which creates an empty tempalte to be filled. This macro kills the whole buffer and trigger this snippet:
